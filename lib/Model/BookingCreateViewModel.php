...
/**
 * BookingCreateViewModel Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BookingCreateViewModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BookingCreateViewModel';
...
'company' => null    ];
    ...
    protected static $attributeMap = [
        'tables' => 'tables',
'force_table_placement' => 'forceTablePlacement',
'walk_in' => 'walkIn',
'pos_id' => 'posId',
...
'company' => 'company'    ];
    ...
    protected static $setters = [
        'tables' => 'setTables',
'force_table_placement' => 'setForceTablePlacement',
'walk_in' => 'setWalkIn',
'pos_id' => 'setPosId',
...
'company' => 'setCompany'    ];
    ...
    protected static $getters = [
        'tables' => 'getTables',
'force_table_placement' => 'getForceTablePlacement',
'walk_in' => 'getWalkIn',
'pos_id' => 'getPosId',
...
'company' => 'getCompany'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['force_table_placement'] = isset($data['force_table_placement']) ? $data['force_table_placement'] : null;
        $this->container['walk_in'] = isset($data['walk_in']) ? $data['walk_in'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['booking_date_time'] === null) {
            $invalidProperties[] = "'booking_date_time' can't be null";
        }
        if ($this->container['booking_duration'] === null) {
            $invalidProperties[] = "'booking_duration' can't be null";
        }
     ...
     * Sets tables
     *
     * @param int[] $tables The table id's for this booking to be placed on. Typically left empty. If omitted, system will find optimal table combination.
     *
     * @return $this
     */
    ...
    /**
     * Gets force_table_placement
     *
     * @return bool
     */
    public function getForceTablePlacement()
    {
        return $this->container['force_table_placement'];
    }

    /**
     * Sets force_table_placement
     *
     * @param bool $force_table_placement Force booking on the given tables even when it conflicts with other bookings. This property is only useful when a list of tables is given.
     *
     * @return $this
     */
    public function setForceTablePlacement($force_table_placement)
    {
        $this->container['force_table_placement'] = $force_table_placement;
    ...
    {
        return $this->container['walk_in'];
    }

    /**
     * Sets walk_in
     *
     * @param bool $walk_in This booking is a walk-in
     *
     * @return $this
     */
    public function setWalkIn($walk_in)
    {
        $this->container['walk_in'] = $walk_in;
     ...
     * Sets pos_id
     *
     * @param string $pos_id The POS identifier
     *
     * @return $this
     */
     ...
     * Sets product_uid
     *
     * @param string $product_uid The identifier of the ticket product you want to reserve. If omitted, we use the default product set for your app. Setting DefaultCreateBookingProductUid
     *
     * @return $this
     */
     ...
     *
     * @param string $external_reference_id The identifier of the external source that created the booking.
     *
     * @return $this
     */
