...
/**
 * RestaurantAppSettingsViewModel Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RestaurantAppSettingsViewModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RestaurantAppSettingsViewModel';
...
'settings' => 'getSettings'    ];
     ...
     * Sets settings
     *
     * @param object $settings The restaurant settings for the app.
     *
     * @return $this
     */
