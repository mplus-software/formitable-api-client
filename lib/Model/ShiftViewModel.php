...
/**
 * ShiftViewModel Class Doc Comment
 *
 * @category Class
 * @description Provides information about the opening times of a restaurant.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ShiftViewModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ShiftViewModel';
...
'product_uid' => 'getProductUid'    ];
     ...
     * Sets start_time
     *
     * @param int $start_time The time the shift starts (restaurant opens) in minutes from midnight.
     *
     * @return $this
     */
     ...
     * Sets end_time
     *
     * @param int $end_time The time the shift ends (restaurant closes) in minutes from midnight.
     *
     * @return $this
     */
     ...
     * Sets product_uid
     *
     * @param string $product_uid The product that is offered for this shift.
     *
     * @return $this
     */
