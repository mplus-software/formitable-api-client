...
'tickets' => '\Swagger\Client\Model\TicketViewModel[]',
...
'tables' => 'getTables'    ];
     ...
     *
     * @param string $external_reference_id The external reference ID of the reservation, based on the source.
     *
     * @return $this
     */
     ...
     * Gets tickets
     *
     * @return \Swagger\Client\Model\TicketViewModel[]
     */
     ...
     * Sets tickets
     *
     * @param \Swagger\Client\Model\TicketViewModel[] $tickets The list of tickets that have been (pre)paid for this booking.
     *
     * @return $this
     */
