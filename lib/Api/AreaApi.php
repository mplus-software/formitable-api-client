...
class AreaApi
{
     ...
     */
    public function areaGet($restaurant_uid, $version)
    {
        list($response) = $this->areaGetWithHttpInfo($restaurant_uid, $version);
        return $response;
    }
     ...
     */
    public function areaGetWithHttpInfo($restaurant_uid, $version)
    {
        $returnType = '\Swagger\Client\Model\AreaViewModel[]';
        $request = $this->areaGetRequest($restaurant_uid, $version);
     ...
     */
    public function areaGetAsync($restaurant_uid, $version)
    {
        return $this->areaGetAsyncWithHttpInfo($restaurant_uid, $version)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function areaGetAsyncWithHttpInfo($restaurant_uid, $version)
    {
        $returnType = '\Swagger\Client\Model\AreaViewModel[]';
        $request = $this->areaGetRequest($restaurant_uid, $version);
     ...
     */
    protected function areaGetRequest($restaurant_uid, $version)
    {
     ...
     * @return \Swagger\Client\Model\AreaViewModel
     */
    public function areaGetById($restaurant_uid, $area_id, $version)
    {
        list($response) = $this->areaGetByIdWithHttpInfo($restaurant_uid, $area_id, $version);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\AreaViewModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function areaGetByIdWithHttpInfo($restaurant_uid, $area_id, $version)
    {
        $returnType = '\Swagger\Client\Model\AreaViewModel';
        $request = $this->areaGetByIdRequest($restaurant_uid, $area_id, $version);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function areaGetByIdAsync($restaurant_uid, $area_id, $version)
    {
        return $this->areaGetByIdAsyncWithHttpInfo($restaurant_uid, $area_id, $version)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function areaGetByIdAsyncWithHttpInfo($restaurant_uid, $area_id, $version)
    {
        $returnType = '\Swagger\Client\Model\AreaViewModel';
        $request = $this->areaGetByIdRequest($restaurant_uid, $area_id, $version);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function areaGetByIdRequest($restaurant_uid, $area_id, $version)
    {
        // verify the required parameter 'restaurant_uid' is set
        if ($restaurant_uid === null || (is_array($restaurant_uid) && count($restaurant_uid) === 0)) {
            throw new \InvalidArgumentException(
