...
**name** | **string** | The (internal) name of the area. Use the FT.Core.ViewModels.Location.AreaViewModel.DisplayName property to show the localized area name to guests. | [optional] 
