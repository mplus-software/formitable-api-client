...
**country_code** | **string** | The two letter ISO country code. | [optional] 
**timezone** | **string** | The timezone in Windows format. Amsterdam will result in &#x27;W. Europe Standard Time&#x27; for example. | [optional] 
...
**min_seating** | **int** | Minimum number of persons that can be seated calculated from all table combinations. | [optional] 
**max_seating** | **int** | Maximum number of persons that can be seated calculated from all table combinations. | [optional] 
...
**min_booking_size** | **int** | The minimum booking size. | [optional] 
**max_booking_size** | **int** | The maximum booking size. | [optional] 
...
**images** | **string[]** | A list containing all the images for the restaurant. | [optional] 
...
**descriptions** | **map[string,string]** | Contains all the localized values of the Description. (English and Dutch) | [optional] 
